...
class MealRestControllerTest extends AbstractControllerTest {
    ...
    void delete() throws Exception {
        ...
        assertThrows(NotFoundException.class, () -> mealService.delete(MEAL1_ID, authUserId()));
    }
    ...
    void getBetween() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(REST_URL + "between?startDate=2015-05-31&startTime=13:00:00&endDate=2015-05-31&endTime=13:00:00"))
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(contentJson(List.of(getTos(MEALS, DEFAULT_CALORIES_PER_DAY).get(1))));
    }
